...
function cltvo_js(){
	...
	wp_register_script( 'cltvo_functions_js', JSPATH.'functions.js', array('jquery', 'cltvo_validate_js', 'cltvo_validate_espanol_js', 'cltvo_mask', /*'cltvo_scrollIt_js', 'cltvo_swiper_js'*/), false, true );
	...
	wp_register_script('cltvo_gsap', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/1.20.3/TweenMax.min.js', false, true);
	wp_register_script('cltvo_scrollmagic', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/ScrollMagic.js', false, true);
	wp_register_script('cltvo_addIndicators', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/debug.addIndicators.js', false, true);
	wp_register_script('cltvo_animation', 'https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/animation.gsap.js', false, true);
	wp_register_script('cltvo_mask', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.13.4/jquery.mask.min.js', false, true);

	wp_localize_script( 'cltvo_functions_js', 'cltvo_js_vars', cltvo_js_vars() );

	wp_enqueue_script('jquery');
	wp_enqueue_script('cltvo_gsap');
	wp_enqueue_script('cltvo_scrollmagic');
	wp_enqueue_script('cltvo_addIndicators');
	wp_enqueue_script('cltvo_animation');
