 ...
 */
 ...
 $special_pages = array(
    ...
    'gradients' => array(
            'Gradients',  // nombre de la pagina
            ""  // slug de de la pagina padre siempre se debe registar la pagina padre
         ),
    'legal' => array(
            'Legal',  // nombre de la pagina
            ""  // slug de de la pagina padre siempre se debe registar la pagina padre
         ),
    'invitation' => array(
            'Invitation',  // nombre de la pagina
            ""  // slug de de la pagina padre siempre se debe registar la pagina padre
        ),
    'about' => array(
            'About',  // nombre de la pagina
            ""  // slug de de la pagina padre siempre se debe registar la pagina padre
        ),
    'contactus' => array(
            'Contact Us',  // nombre de la pagina
            ""  // slug de de la pagina padre siempre se debe registar la pagina padre
        ),
    'car' => array(
            'Car',  // nombre de la pagina
            ""  // slug de de la pagina padre siempre se debe registar la pagina padre
        ),
	'privacypolicy' => array(
		'Privacy Policy',  // nombre de la pagina
		""  // slug de de la pagina padre siempre se debe registar la pagina padre
	),
	'faq' => array(
		'Faq',  // nombre de la pagina
		""  // slug de de la pagina padre siempre se debe registar la pagina padre
	),
	'termsofuse' => array(
		'Terms of use',  // nombre de la pagina
		""  // slug de de la pagina padre siempre se debe registar la pagina padre
	),
    'press' => array(
        'Press',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'es' => array(
        'Es',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'partnerwithus' => array(
        'Partner With Us',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'press-release' => array(
        'Press Release',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
);
